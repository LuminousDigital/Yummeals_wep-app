...
@section('content')
    ...
    <p style="margin:0 0 12px 0;font-size:15px;line-height:1.6;color:#374151;">Your One-Time Password (OTP) is <span style="font-weight:700;background:#f3f4f6;border-radius:8px;padding:8px 12px;color:#111827;">{{ $otp }}</span></p>
