<template>
    <DeliveryAddressModal
        ...
        @location-covered="onLocationCovered"
        @location-not-covered="onLocationNotCovered"
    />
    ...
    >
        <div class="modal-dialog" v-if="itemInfo">
            <div class="modal-header">
                <h3 class="modal-title text-base font-medium">
                    {{ itemInfo.name }}
                </h3>
                <button
                    ...
                    <div class="flex-auto">
                        <div class="flex items-start gap-2 mb-1">
                            ...
                            <button
                                ...
                                data-modal="#item-info-modal"
                                @click.prevent="
                                    infoModalShow(item.name, item.caution)
                                "
                            >
                                <i
                                    class="lab lab-information font-fill-paragraph transition lab-font-size-16"
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            <h3
                                                class="block capitalize text-xs text-heading"
                                            >
                                                {{
                                                    textShortener(
                                                        variation.name,
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div>
                                            <h3
                                                class="block capitalize mb-1 text-xs text-heading"
                                            >
                                                {{
                                                    textShortener(
                                                        extra.name,
                            ...
                            >
                                <div class="swiper-slide">
                                    ...
                                    >
                                        ...
                                        />
                                        <div
                                            class="rounded-r-lg w-full py-1 px-2"
                                        >
                                            <span
                                    ...
                                    >
                                        ...
                                        <div
                                            class="flex items-center indec-group"
                                        >
                                            <button
                                                @click.prevent="
                                                    addonQuantityDecrement(
                                                        addon.id
                                                    )
                                                "
                                            ...
                                            <input
                                                ...
                                                "
                                                v-on:keyup="
                                                    addonQuantityUp(addon.id)
                                                "
                                                v-model="
                                                    addonQuantity[addon.id]
                                                "
                                                type="number"
    ...
    methods: {
        ...
        onLocationCovered() {
            ...
            if (this.selectedItem) {
                this.variationModalShow(this.selectedItem);
            }
        },

        onLocationNotCovered(addressData) {
            // Close delivery modal and show waitlist modal
            this.showDeliveryModal = false;
            this.showWaitlistModal = true;
        },
                ...
                .then((res) => {
                    ...
                    if (this.item.itemAttributes.length > 0) {
                        _.forEach(this.item.itemAttributes, (element) => {
                            if (
                                typeof this.item.variations[element.id][0] !==
                                "undefined"
                            ) {
        ...
        totalPriceSetup: function () {
            ...
            _.forEach(
                ...
                (variationId, attributeId) => {
                    _.forEach(
                        this.item.variations[attributeId],
                        (itemVariation) => {
                            if (variationId === itemVariation.id) {
                                item_variation_total +=
                                    itemVariation.convert_price;
                            }
                        }
                    );
                }
            ...
            if (typeof this.addons[addon.id] === "undefined") {
                ...
                if (
                    ...
                    _.forEach(addon.variations, (variationId, attributeId) => {
                        this.addons[addon.id].item_variations.variations[
                            attributeId
                        ] = variationId;
                    });
                }
