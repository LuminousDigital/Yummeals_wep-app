<template>
    <section class="pt-16 pb-12 flex flex-col items-center justify-center text-center">
        ...
        <router-link v-if="Object.keys(authDefaultPermission).length > 0" :to="type+'/'+authDefaultPermission.url" class="w-full max-w-[250px] py-3 rounded-lg capitalize text-base font-medium leading-6 text-center bg-primary text-white">
