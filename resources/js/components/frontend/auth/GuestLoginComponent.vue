    ...
    <section class="pt-28 pb-16">
        <div class="container max-w-[600px] py-6 p-4 mb-6 sm:mt-12 sm:pb-12  sm:pt-8 sm:px-12 md:shadow-md rounded-2xl bg-white md:border">
            ...
            <form @submit.prevent="save">
                <div class="mb-6">
                    <label class="text-sm capitalize mb-1 text-heading-light tracking-[1px]">{{ $t('label.mobile_number') }}</label>
                    <div class="w-full h-12 rounded-lg border pl-4 flex items-center border-[#D9DBE9] bg-[#eff0f6] focus:bg-white">
