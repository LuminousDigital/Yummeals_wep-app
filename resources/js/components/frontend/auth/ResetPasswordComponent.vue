<template>
    ...
    <section class="pt-28 pb-16">
        ...
        >
            <h2
                class="capitalize sm:my-8 mb-6 mt-6 sm:mt-0 text-center text-[22px] md:text-2xl font-normal leading-[34px] text-heading-light tracking-[1px]"
            >
            ...
            <form @submit.prevent="resetPassword">
                <div class="mb-4 relative">
                    <label
                        class="text-sm capitalize mb-1 text-heading-light tracking-[1px]"
