            ...
            <div class="row">
                <div class="col-12 md:col-7">
                    <div class="p-4 mb-6 rounded-2xl shadow-xs bg-white">
                        ...
                        >
                            <i
                                class="lab lab-location text-xl text-primary"
                            ></i>
                        ...
                        >
                            <div
                                class="flex flex-wrap justify-between gap-5 mb-2.5"
                            >
                                ...
                                <div class="flex gap-3">
                                    <button
                                        v-if="
                                            Object.keys(localAddress).length !==
                                            0
                                        "
                                        @click="editAddress"
                                        type="button"
                            ...
                            >
                                ...
                                >
                                    ...
                                    >
                                        <div
                                            class="flex items-center gap-2 text-xs text-[#008BBA]"
                                        >
                                            <i class="icon-home"></i>
                                    ...
                                    <div
                                        class="text-xs flex gap-2 text-[#1F1F39]"
                                    >
                            ...
                            <div class="flex flex-wrap items-start gap-4">
                                ...
                                >
                                    <dl class="flex-auto">
                                        ...
                                        <dd
                                            class="text-sm whitespace-nowrap text-heading"
                                        >
                                            {{
                                ...
                                >
                                    <dl class="flex-auto">
                                        ...
                                        >
                                            {{
                                                localDeliveryTimeLabel ||
                                                $t("label.choose_a_time")
                                            }}
                                        </dd>
                                    </dl>
                                    <div class="custom-radio sm">
...
export default {
    ...
    mounted() {
        ...
        this.$store
            ...
            .then((res) => {
                if (
                    (res.data.data.order_setup_delivery ===
                        activityEnum.DISABLE &&
                        res.data.data.order_setup_takeaway ===
                            activityEnum.DISABLE) ||
        ...
        this.$store
            ...
            .then((res) => {
                this.loading.isActive = false;
                this.checkoutProps.form.is_advance_order =
                    isAdvanceOrderEnum.NO;
            })
            .catch((err) => {
                this.loading.isActive = false;
        ...
        if (Object.keys(this.timeSlot).length > 0) {
            ...
            this.checkoutProps.form.is_advance_order =
                this.timeSlot.is_advance_order;
    ...
    methods: {
        ...
        editAddress: function () {
            if (
                ...
                this.$store
                    .dispatch(
                        "frontendAddress/edit",
                        this.checkoutProps.form.address_id
                    )
                    .then((res) => {
                        this.loading.isActive = false;

                        this.addressProps.form.address =
                            this.localAddress.address;
                        this.addressProps.form.apartment =
                            this.localAddress.apartment;
                        this.addressProps.form.latitude =
                            this.localAddress.latitude;
                        this.addressProps.form.longitude =
                            this.localAddress.longitude;
        ...
        //                 if (
        //                     distance >
        //                     this.setting.order_setup_free_delivery_kilometer
        //                 ) {
        //                     let extraDistance =
        //                         distance -
        //                         parseFloat(
        ...
        //                         extraDistance *
        //                             parseFloat(
        //                                 this.setting.order_setup_charge_per_kilo
        //                             ) +
        //                         parseFloat(
        //                             this.setting
        ...
        deliveryChargeCalculation: function () {
            if (
                ...
                this.$store
                    ...
                    .then((branchRes) => {
                        this.checkoutProps.form.branch_id = branchRes.id;
                        const distance = appService.distance(
                            parseFloat(this.localAddress.latitude),
                            parseFloat(this.localAddress.longitude),
                            parseFloat(branchRes.latitude),
                            parseFloat(branchRes.longitude)
                        );
