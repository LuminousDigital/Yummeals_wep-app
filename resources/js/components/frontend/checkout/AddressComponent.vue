    ...
    <div id="address-modal" class="modal address-modal ff-modal">
        <div class="modal-dialog">
            <div class="modal-header border-none pb-0">
                ...
                <button
                    class="modal-close fa-regular lab lab-close-circle-line lab-font-size-22 lab-font-bold"
                    @click="reset"
                ></button>
            </div>
            <div class="modal-body">
                <form @submit.prevent="save">
                    ...
                    <div class="mb-3">
                        <h3
                            class="text-xs leading-6 capitalize mb-1 text-heading"
                        >
                    ...
                    <div class="mb-6">
                        ...
                        <nav class="flex flex-wrap gap-3 active-group">
                            <button
                                @click="changeSwitchLabel(labelEnum.HOME)"
                                :class="
                                    props.switchLabel === labelEnum.HOME
                                        ? 'active'
                                        : ''
                                "
                                v-on:click="
                            ...
                            >
                                <i
                                    class="lab lab-home text-base leading-none"
                                ></i>
                                <span
                                    class="text-sm capitalize font-medium leading-none text-heading"
                                    >{{ $t("label.home") }}</span
                                >
                            </button>
                            <button
                                @click="changeSwitchLabel(labelEnum.WORK)"
                                :class="
                                    props.switchLabel === labelEnum.WORK
                                        ? 'active'
                                        : ''
                                "
                                v-on:click="
                            ...
                            >
                                <i
                                    class="lab lab-briefcase text-base leading-none"
                                ></i>
                                <span
                                    class="text-sm capitalize font-medium leading-none text-heading"
                                >
                            ...
                            <button
                                @click="changeSwitchLabel(labelEnum.OTHER)"
                                :class="
                                    props.switchLabel === labelEnum.OTHER
                                        ? 'active'
                                        : ''
                                "
                                v-on:click="
                            ...
                            >
                                <i
                                    class="lab lab-more-square text-base leading-none"
                                ></i>
                                <span
                                    class="text-sm capitalize font-medium leading-none text-heading"
                                    >{{ $t("label.other") }}</span
                        ...
                        <div
                            v-if="props.status"
                            :class="!props.status ? 'h-0' : ''"
                            class="overflow-hidden transition"
                        >
                            <input
                                type="text"
                                :placeholder="$t('label.type_label_name')"
                                v-model="props.form.label"
